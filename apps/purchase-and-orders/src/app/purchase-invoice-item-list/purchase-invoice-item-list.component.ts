...
@Component({
  selector: 'purchase-purchase-invoice-item-list',
  standalone: true,
  imports: [CommonModules, ClDataTableComponent],
  templateUrl: './purchase-invoice-item-list.component.html',
})
export class PurchaseInvoiceItemListComponent
  ...
  items = model<PurchaseInvoiceItemModel[]>([]);
  onRemove = output<{ removedItem: PurchaseInvoiceItemModel, items: PurchaseInvoiceItemModel[] }>();
