...
export class ExportDeliverySerialNumbersExcelFileUseCase implements UseCase<GoodsDeliveryModel, AttachmentModel> {
  ...
  execute(filters: GoodsDeliveryModel): Observable<AttachmentModel> {
    ...
    return this.#goodsDeliveryGateway.exportSerialNumbersExcel(filters);
  }
}
