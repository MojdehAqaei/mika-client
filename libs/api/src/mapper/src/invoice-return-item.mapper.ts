...
export class InvoiceReturnItemMapper implements Mapper<InvoiceItemDto, InvoiceReturnItemModel> {
  mapFrom(param: InvoiceReturnItemModel): InvoiceItemDto {
    return {
      id: param.id,
  ...
  mapTo(param: InvoiceItemDto): InvoiceReturnItemModel {
